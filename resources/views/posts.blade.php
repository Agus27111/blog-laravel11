...
<x-slot:title>{{$title}}</x-slot:title>
    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-gray-300 ">
        ...
        <div class="text-gray-500 text-base">
            ...
            in
            <a href="/categories/{{$post->category->slug}}" class="hover:underline">{{$post->category->name}}</a> | {{ $post->created_at->format('j F Y') }}
        </div>
        ...
        <a  class="font-medium text-blue-500 hover:underline" href="posts/{{$post['slug']}}">Read more &raquo;</a>
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        ...
                        <span class=" text-white text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:underline" style="background-color: {{ $post->category->color }};">
                            {{ $post->category->name }}
                        </span>
                        </a>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="/posts?author={{$post->author->username}}" class="font-medium text-gray-900 dark:text-white hover:underline">
            ...
            @empty
            <div>
                <p class="font-semibold text-xl my-3">Article not found!</p>
